...
import { ClassProps } from 'modules'; // eslint-disable-line

/* eslint-disable */
class PureBlog extends Component { // eslint-disable-line
  render() {
    const file1 = require("public/img/andrew-avatar.png");
    return (
      <ClassProps>
<div id="layout" class="pure-g">
    <div class="sidebar pure-u-1 pure-u-md-1-4">
        <div class="header">
            <h1 class="brand-title">A Sample Blog2</h1>
    ...
    <div class="content pure-u-1 pure-u-md-3-4" id="yui_3_18_1_1_1497529733924_14">
        <div id="yui_3_18_1_1_1497529733924_13">
            <div class="posts" id="yui_3_18_1_1_1497529733924_12">
                <h1 class="content-subhead">Pinned Post</h1>

                <section class="post" id="yui_3_18_1_1_1497529733924_10">
                    <header class="post-header">
                        <img width="48" height="48" alt="Tilo Mitra's avatar" class="post-avatar" src={file1} />
...
PureBlog.propTypes = routePropTypes;
PureBlog.defaultProps = routeDefaultProps;

export default PureBlog;
